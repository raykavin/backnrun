...
func TestController_updatePosition(t *testing.T) {
	t.Run("market orders", func(t *testing.T) {
		...
		_, err = controller.CreateOrderMarket(core.SideTypeBuy, "BTCUSDT", 1)
		require.NoError(t, err)
		...
		order, err := controller.CreateOrderMarket(core.SideTypeSell, "BTCUSDT", 1)
		require.NoError(t, err)
	...
	t.Run("limit order", func(t *testing.T) {
		...
		_, err = controller.CreateOrderLimit(core.SideTypeBuy, "BTCUSDT", 1, 1000)
		require.NoError(t, err)
		...
		_, err = controller.CreateOrderLimit(core.SideTypeSell, "BTCUSDT", 1, 2000)
		require.NoError(t, err)
	...
	t.Run("oco order limit maker", func(t *testing.T) {
		...
		_, err = controller.CreateOrderOCO(core.SideTypeSell, "BTCUSDT", 1, 2000, 500, 500)
		require.NoError(t, err)
	...
	t.Run("oco stop sell", func(t *testing.T) {
		...
		_, err = controller.CreateOrderLimit(core.SideTypeBuy, "BTCUSDT", 0.5, 1000)
		require.NoError(t, err)

		_, err = controller.CreateOrderLimit(core.SideTypeBuy, "BTCUSDT", 1.5, 1000)
		require.NoError(t, err)
		...
		_, err = controller.CreateOrderMarket(core.SideTypeBuy, "BTCUSDT", 1.0)
		require.NoError(t, err)
	...
	t.Run("short market", func(t *testing.T) {
		...
		_, err = controller.CreateOrderMarket(core.SideTypeSell, "BTCUSDT", 1)
		require.NoError(t, err)
