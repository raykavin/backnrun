...
func (g *GridSearch) generateParameterValues(param Parameter) ([]interface{}, error) {
	switch param.Type {
	case TypeInt:
	...
	case TypeBool:
		return []interface{}{true, false}, nil
...
func (g *GridSearch) generateIntValues(param Parameter) ([]interface{}, error) {
...
func (g *GridSearch) generateFloatValues(param Parameter) ([]interface{}, error) {
...
func (g *GridSearch) runEvaluations(
	ctx context.Context,
	evaluator Evaluator,
...
func (g *GridSearch) logf(format string, args ...interface{}) {
	if g.logger != nil {
