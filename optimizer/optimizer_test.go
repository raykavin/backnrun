...
func (m *MockEvaluator) Evaluate(ctx context.Context, params core.ParameterSet) (*core.OptimizerResult, error) {
...
func TestParameterValidation(t *testing.T) {
	...
	// Valid parameter set
	validParams := core.ParameterSet{
		"intParam":   50,
		"floatParam": 0.5,
	}

	// Invalid parameter set (missing parameter)
	missingParams := core.ParameterSet{
		"intParam": 50,
	}

	// Invalid parameter set (wrong type)
	wrongTypeParams := core.ParameterSet{
...
func TestResultSorter(t *testing.T) {
	...
	results := []*core.OptimizerResult{
		{
			Parameters: core.ParameterSet{"param": 1},
		...
		{
			Parameters: core.ParameterSet{"param": 2},
			Metrics: map[string]float64{
				"profit": 200.0,
				"risk":   0.8,
			},
		...
		{
			Parameters: core.ParameterSet{"param": 3},
			Metrics: map[string]float64{
				"profit": 150.0,
				"risk":   0.3,
			},
