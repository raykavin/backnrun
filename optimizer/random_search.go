...
func (r *RandomSearch) SetParameters(params []core.Parameter) error {
	if len(params) == 0 {
...
func (r *RandomSearch) generateRandomParameterSets() []core.ParameterSet {
	parameterSets := make([]core.ParameterSet, r.maxIterations)

	for i := 0; i < r.maxIterations; i++ {
		paramSet := make(core.ParameterSet)
...
func (r *RandomSearch) generateRandomValue(param core.Parameter) any {
	switch param.Type {
	case core.TypeInt:
...
func (r *RandomSearch) generateRandomInt(param core.Parameter) int {
...
func (r *RandomSearch) generateRandomFloat(param core.Parameter) float64 {
...
func (r *RandomSearch) generateRandomOption(param core.Parameter) any {
...
func (r *RandomSearch) runEvaluations(
	ctx context.Context,
	evaluator core.Evaluator,
	parameterSets []core.ParameterSet,
) ([]*core.OptimizerResult, error) {
	var (
...
func (r *RandomSearch) logf(format string, args ...any) {
	if r.log != nil {
